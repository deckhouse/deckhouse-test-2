...
# Final werf images used only to attach attestations. They are excluded from
# images_digests.json (hasSuffix "artifact"), so compact keys come from parent.
...
def compute_changed(
    ...
    for name, entry in images.items():
        ...
        # Attestation sidecars are final images but are omitted from
        # images_digests.json. Map them to the attested parent so scanners
        # still receive a real compact key via changed_compact / ONLY_IMAGES.
